...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="D:\Civ6Mod\Terrain\Hills\FungalHills_HM.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>2078713169</m_ExportedTime>
	<m_ClassName text="TerrainElementHeightmap"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="FungalHills_HM.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="FungalHills_HM"/>
	<m_Description text=""/>
	<m_Tags/>
	<m_Groups/>
</AssetObjects..TextureInstance>
