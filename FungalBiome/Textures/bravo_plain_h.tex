...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="D:\Civ6Mod\Terrain\BE-Biomes\Fungal\bravo_plain_h.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>29967318</m_ExportedTime>
	<m_ClassName text="Terrain_Heightmap"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="bravo_plain_h.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="bravo_plain_h"/>
	<m_Description text=""/>
	<m_Tags/>
	<m_Groups/>
</AssetObjects..TextureInstance>
