...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="D:\Civ6Mod\Terrain\BE-Biomes\Fungal\forest_bravoOPAC.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>1288383061</m_ExportedTime>
	<m_ClassName text="Generic_OPAC"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="forest_bravoOPAC.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="forest_bravoOPAC"/>
	<m_Description text=""/>
	<m_Tags/>
	<m_Groups/>
</AssetObjects..TextureInstance>
